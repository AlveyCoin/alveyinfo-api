...
class ContractService extends Service {
    ...
    return {
      ...
      ...contract.type === 'arc20' ? {
        arc20: {
          ...
          holders: contract.arc20.statistics.holders,
          transactions: contract.arc20.statistics.transactions
        }
      } : {},
  ...
  async getContractBasicTransactions(contractAddress) {
    const {Address, OutputScript} = this.app.alveyinfo.lib
    const {
