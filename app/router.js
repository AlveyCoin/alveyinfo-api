module.exports = app => {
  ...
  router.get(
    '/address/:address/arc20-balance/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.arc20TokenBalance
  )
  router.get(
    '/address/:address/txs',
  ...
  router.get(
    '/address/:address/arc20-txs/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.arc20TokenTransactions
  )
  router.get(
    '/address/:address/arc20-mempool-txs/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.arc20TokenMempoolTransactions
  )
  router.get(
  ...
  router.get(
    '/address/:address/arc20-balance-history',
    addressMiddleware, paginationMiddleware,
    controller.address.arc20BalanceHistory
  )
  router.get(
    '/address/:address/arc20-balance-history/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.arc20BalanceHistory
  )
  ...
  router.get(
    '/contract/:contract/arc20-balance-history/:token',
  ...
  router.get(
    '/arc20/txs',
    paginationMiddleware,
    controller.arc20.allTransactions
  )
  router.get(
    '/arc20/:token/txs',
    middleware.contract('token'), paginationMiddleware, blockFilterMiddleware,
    controller.arc20.transactions
  )
  router.get(
    '/arc20/:token/rich-list',
